...
\end{figure}
		...
		\item {\Large \textbf{locate(f, d, minmass, sepration)}}: \\ \\
    			...
    			Es wäre interessant zu erwähnen, dass es sich dabei um den minimalen Abstand zwischen zwei Teilchen handelt. Der Standardwert ist Durchmesser + 1. In diesem Fall ist es 6. 
